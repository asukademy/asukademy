...
JS;
		...
		$asset->addScript(Uri::media(true) . 'riki/js/chosen/chosen.jquery.min.js');
		$asset->addStyle(Uri::media(true) . 'riki/js/chosen/chosen.min.css');
	}
	...
	public static function requireJS()
	{
		...
		$asset->addScript(Uri::media(true) . 'riki/js/core/require.js');
	...
	public static function underscore($noConflict = true)
	{
		...
		$asset->addScript(Uri::media(true) . 'riki/js/core/underscore.js');
	...
	public static function backbone($noConflict = false)
	{
		...
		$asset->addScript(Uri::media(true) . 'riki/js/core/backbone.js');
	...
	{
		return Ioc::get('riki.asset', $name);
	}
}
